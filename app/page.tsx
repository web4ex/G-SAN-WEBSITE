    ...
    return (
        <main className="min-h-screen bg-white font-sans text-black selection:bg-red-600 selection:text-white overflow-x-hidden">
            ...
            <section className="py-20 bg-zinc-50 overflow-hidden relative">
                ...
                <div className="container mx-auto px-4">
                    <div className="relative w-full max-w-5xl mx-auto aspect-video bg-white rounded-3xl shadow-xl border border-zinc-200 overflow-hidden">
                        <div className="absolute inset-0 bg-zinc-50">
                            <iframe
                                ...
                                marginHeight={0}
                                marginWidth={0}
                                src="https://www.openstreetmap.org/export/embed.html?bbox=7.1,46.4,10.2,48.15&amp;layer=mapnik"
                                className="w-full h-full opacity-80"
                                style={{ pointerEvents: 'none' }}
                            ></iframe>
                        </div>

                        {/* Interactive Pins - Recalculated for Full Switzerland BBox at 16:9 */}
                        <div className="absolute inset-0 pointer-events-none">
                            <div className="relative w-full h-full">
                                {[
                                    { name: "Zürich", top: "44.6%", left: "46.5%" },
                                    { name: "Zug", top: "56.0%", left: "45.8%" },
                                    { name: "Aargau", top: "42.9%", left: "34.0%" },
                                    { name: "Luzern", top: "62.9%", left: "39.0%" },
                                    { name: "Schwyz", top: "64.6%", left: "50.0%" },
                                    { name: "St. Gallen", top: "41.7%", left: "71.0%" },
                                    { name: "Thurgau", top: "33.7%", left: "58.1%" },
                                ].map((loc, i) => (
                                    <div
                                        key={i}
            ...
            <footer id="contact" className="bg-zinc-950 text-white py-20 border-t-4 border-red-600">
                <div className="container mx-auto px-4">
                    ...
                    <div className="pt-8 border-t border-zinc-900 flex flex-col md:flex-row justify-between items-center gap-4 text-zinc-600 text-xs">
                        <p>
                            &copy; {new Date().getFullYear()} G-San Gebäudetechnik GmbH.
                            <span className="mx-2">|</span>
                            Powered by <a href="https://www.web4ex.ch" target="_blank" rel="noopener noreferrer" className="hover:text-red-500 transition-colors">WEB4EX</a>
                        </p>
